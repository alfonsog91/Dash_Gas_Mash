...
const HEADING_CONE_HALF_ANGLE_MOVING = 22;
const HEADING_CONE_HALF_ANGLE_STATIONARY = 32;
const HEADING_CONE_SPEED_FOR_FULLY_MOVING = 3;
const HEADING_SENSOR_STALE_AFTER_MS = 2200;
const HEADING_SENSOR_SMOOTHING_TIME_MS = 110;
const HEADING_SENSOR_SMOOTHING_MIN_BLEND = 0.36;
const HEADING_FILTER_SMOOTHING_FACTOR = 0.62;
...
const HEADING_GPS_FALLBACK_SMOOTHING_TIME_MS = 340;
const HEADING_CONE_BASE_OPACITY = 0.58;
const HEADING_CONE_TIP_OPACITY = 0.16;
