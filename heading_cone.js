...
const HEADING_SENSOR_SMOOTHING_TIME_MS = 140;
const HEADING_SENSOR_SMOOTHING_MIN_BLEND = 0.26;
const HEADING_FILTER_SMOOTHING_FACTOR = 0.38;
const HEADING_FILTER_DEAD_ZONE_DEGREES = 0.75;
const HEADING_FILTER_MIN_ROTATION_DEGREES = 0.45;
const HEADING_SENSOR_MAX_WEBKIT_COMPASS_ACCURACY_DEGREES = 30;
const HEADING_GPS_FALLBACK_SMOOTHING_TIME_MS = 520;
